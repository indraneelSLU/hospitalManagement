<?php
session_start();
$con=mysqli_connect("localhost","csci5710","password","myhmsdb");
if(isset($_POST['patsub'])){
    ...
    echo("<script>alert('Invalid Username or Password. Try Again! func');
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> SSM Healthcare</a>
